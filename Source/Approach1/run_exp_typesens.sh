...
cp mono_en_test.txt mono_vn_test.txt bi_test.txt mono_en_mono_vn_test.txt mono_en_bi_test.txt mono_vn_bi_test.txt mono_en_mono_vn_bi_test.txt ./Result_Naive_TranslationNormalized